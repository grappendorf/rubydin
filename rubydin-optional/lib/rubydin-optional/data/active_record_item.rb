...
module Rubydin
	...
	class ActiveRecordProperty < Java::com.vaadin.data.util.AbstractProperty
	...
	class ActiveRecordItem < Java::com.vaadin.data.util.PropertysetItem
		...
		def initialize data
			super()
			@data = data
			properties = data.attribute_names.map(&:to_sym)
